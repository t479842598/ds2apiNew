...
func TestChatCompletionsUploadsInlineFilesBeforeCompletion(t *testing.T) {
	...
	reqBody := `{"model":"deepseek-vision","messages":[{"role":"user","content":[{"type":"input_text","text":"hi"},{"type":"image_url","image_url":{"url":"data:image/png;base64,QUJDRA=="}}]}],"stream":false}`
